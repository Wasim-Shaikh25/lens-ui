...
// import { getAll, deleteDetail } from '../../apis/PumpSealApi';
...
//     const encodedDrfNumber = encodeURIComponent(detail.drfNumber);

//     navigate(`/createPump/${encodedDrfNumber}`);
...
//       try {
//         await deleteDetail(id, data, setData);
...
//                         onClick={() => handleDelete(row.pumpSealDrfNumber)}
//                       >
